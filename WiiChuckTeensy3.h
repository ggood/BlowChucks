...
class WiiChuckTeensy3 {
    ...
    public:
        ...
        WiiChuckTeensy3(unsigned int bus_num) {
          pins = bus_num == 0 ? I2C_PINS_18_19 : I2C_PINS_16_17;
        }
        
        void begin() 
        {
            Wire.begin(I2C_MASTER, 0, pins, I2C_PULLUP_EXT, I2C_RATE_100);
            cnt = 0;
            averageCounter = 0;
        ...
        void update() {
            ...
            Wire.pinConfigure(pins, I2C_PULLUP_INT);  // Make sure we're talking to the right bus
